...
const Text = (props) => {
  const { children, is_size, is_color, is_margin, is_padding, _onClick, is_bold, is_height, is_width, is_center, is_line_height, is_box_sizing, is_stroke, is_border } = props;
