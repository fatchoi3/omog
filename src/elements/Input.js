...
const ElInput = styled.input`
  ...
  ${(props) =>
    props.is_border_bottom ? `border-bottom: ${props.is_border_bottom};` : ""};
  ${(props) =>
    props.is_border_top ? `border-top: ${props.is_border_top};` : ""};
  ${(props) =>
    props.is_box_sizing ? `box-sizing: ${props.is_box_sizing};` : "border-box"};
  ${(props) =>
    props.is_font_size ? `font-size: ${props.is_font_size};` : "14px"};
